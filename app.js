...
(function () {
  ...
  const CATALOG = [
    { id:'p1', brand:'Laneige', name:'Lip Sleeping Mask — Berry', price:18, image:'images/products/laneige-lip-sleeping-mask.jpg', photo: 'https://images.unsplash.com/photo-1631214540242-3a4d1c5fa3b8?w=600&h=750&fit=crop&q=80&auto=format', size:'20 g', category:'skincare', rating:4.9, reviews:2841,
    ...
    { id:'p2', brand:'COSRX', name:'Advanced Snail 96 Mucin Power Essence', price:15, image:'images/products/cosrx-snail-essence.jpg', photo: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600&h=750&fit=crop&q=80&auto=format', size:'100 ml', category:'skincare', rating:4.9, reviews:8512,
    ...
    { id:'p3', brand:'YSL Beauty', name:'Libre Eau de Parfum 90ml', price:135, image:'images/products/ysl-libre-edp.jpg', photo: 'https://images.unsplash.com/photo-1547887537-6158d64c35b3?w=600&h=750&fit=crop&q=80&auto=format', size:'90 ml', category:'fragrance', rating:4.8, reviews:1204,
    ...
    { id:'p4', brand:'La Roche-Posay', name:'Anthelios UVMune 400 SPF50+ Sunscreen', price:22, image:'images/products/laroche-anthelios.jpg', photo: 'https://images.unsplash.com/photo-1583241475880-083f84372725?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'skincare', rating:4.7, reviews:3915,
    ...
    { id:'p5', brand:'Dior', name:'Rouge Dior 999 Velvet Lipstick', price:52, image:'images/products/dior-rouge-999.jpg', photo: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=600&h=750&fit=crop&q=80&auto=format', size:'3.2 g', category:'makeup', rating:4.9, reviews:12403,
    ...
    { id:'p6', brand:'Innisfree', name:'Green Tea Seed Hyaluronic Serum', price:17, image:'images/products/innisfree-green-tea.jpg', photo: 'https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'skincare', rating:4.6, reviews:1729,
    ...
    { id:'p7', brand:'Anessa', name:'Perfect UV Sunscreen Skincare Milk SPF50+', price:25, image:'images/products/anessa-perfect-uv.jpg', photo: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=600&h=750&fit=crop&q=80&auto=format', size:'60 ml', category:'skincare', rating:4.9, reviews:5612,
    ...
    { id:'p8', brand:'The Ordinary', name:'Niacinamide 10% + Zinc 1% Serum', price:12, image:'images/products/the-ordinary-niacinamide.jpg', photo: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=600&h=750&fit=crop&q=80&auto=format', size:'30 ml', category:'skincare', rating:4.7, reviews:18247,
    ...
    { id:'t1', brand:'Charlotte Tilbury', name:'Pillow Talk Lipstick', price:39, image:'images/products/charlotte-tilbury-pillow-talk.jpg', photo: 'https://images.unsplash.com/photo-1583241800698-e8ab01830a07?w=600&h=750&fit=crop&q=80&auto=format', size:'3.5 g', category:'makeup', rating:4.8, reviews:9203,
    ...
    { id:'t2', brand:'Glow Recipe', name:'Watermelon Glow Niacinamide Dew Drops', price:46, image:'images/products/glow-recipe-watermelon.jpg', photo: 'https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?w=600&h=750&fit=crop&q=80&auto=format', size:'40 ml', category:'skincare', rating:4.7, reviews:4892,
    ...
    { id:'t3', brand:'Tom Ford', name:'Black Orchid Eau de Parfum', price:185, image:'images/products/tom-ford-black-orchid.jpg', photo: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'fragrance', rating:4.9, reviews:6521,
    ...
    { id:'t4', brand:'Sulwhasoo', name:'First Care Activating Serum', price:78, image:'images/products/sulwhasoo-first-care.jpg', photo: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=600&h=750&fit=crop&q=80&auto=format', size:'60 ml', category:'skincare', rating:4.8, reviews:2156,
    ...
    { id:'t5', brand:'Maybelline', name:'Sky High Volume Mascara', price:11, image:'images/products/maybelline-sky-high.jpg', photo: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=600&h=750&fit=crop&q=80&auto=format', size:'7 ml', category:'makeup', rating:4.6, reviews:23104,
    ...
    { id:'t6', brand:'Jo Malone', name:'Wood Sage & Sea Salt Cologne', price:142, image:'images/products/jomalone-wood-sage.jpg', photo: 'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=600&h=750&fit=crop&q=80&auto=format', size:'100 ml', category:'fragrance', rating:4.7, reviews:3812,
    ...
    // ===== MAKEUP additions =====
    { id:'m1', brand:'Fenty Beauty', name:'Pro Filt\'r Soft Matte Longwear Foundation', price:40, image:'images/products/charlotte-tilbury-pillow-talk.jpg', photo: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=600&h=750&fit=crop&q=80&auto=format', size:'32 ml', category:'makeup', rating:4.7, reviews:14820,
      tags:'foundation makeup base inclusive shade matte longwear',
      description: 'The cult foundation that broke the internet — 50 shades, soft matte finish, 24-hour wear. Climate-adaptive technology keeps you flawless from morning meeting to midnight cocktail.',
      benefits: ['50 shades — actually inclusive','Soft matte, 24-hour wear','Sweat-resistant, smudge-proof','Buildable medium-to-full coverage'],
      howTo: 'Shake well. Dispense a small amount onto the back of your hand. Apply with a damp Beauty Blender, brush, or fingers — blend outward from the center of the face.',
      ingredients: 'Aqua, Cyclopentasiloxane, PEG-10 Dimethicone, Phenyl Trimethicone, Disteardimonium Hectorite, Sodium Chloride, Tocopheryl Acetate.' },
    { id:'m2', brand:'Urban Decay', name:'Naked Heat Eyeshadow Palette', price:54, image:'images/products/dior-rouge-999.jpg', photo: 'https://images.unsplash.com/photo-1583241475880-083f84372725?w=600&h=750&fit=crop&q=80&auto=format', size:'13.6 g', category:'makeup', rating:4.8, reviews:8743,
      tags:'eyeshadow palette warm copper bronze burnt orange smokey eye',
      description: 'Twelve scorched neutrals — coppers, ambers, rich browns — for a sunset-on-your-eyes look. Buttery pigment, blendable formula, magnetic palette with full-size mirror.',
      benefits: ['12 warm-toned shades','Buttery, blendable formula','Hi-pigment payoff','Built-in mirror'],
      howTo: 'Sweep a light copper across the lid. Deepen the crease with a burnt orange. Smoke the outer corner with the darkest shade.',
      ingredients: 'Talc, Synthetic Fluorphlogopite, Octyldodecyl Stearoyl Stearate, Caprylyl Glycol, Phenoxyethanol, Mica, CI 77491, CI 77492, CI 77499.' },
    { id:'m3', brand:'NARS', name:'Orgasm Blush', price:32, image:'images/products/charlotte-tilbury-pillow-talk.jpg', photo: 'https://images.unsplash.com/photo-1631214540242-3a4d1c5fa3b8?w=600&h=750&fit=crop&q=80&auto=format', size:'4.8 g', category:'makeup', rating:4.9, reviews:18204,
      tags:'blush peachy pink shimmer cheeks orgasm nars iconic',
      description: 'The most famous blush in the world. A universal peachy-pink with a golden shimmer that mimics a natural flush on every skin tone. The compact you reach for at 7am AND 7pm.',
      benefits: ['Universally flattering shade','Subtle golden shimmer','Buildable, blendable','12-hour wear'],
      howTo: 'Smile at yourself in the mirror. Sweep across the apples of your cheeks with a fluffy brush. Blend upward toward the temple.',
      ingredients: 'Mica, Talc, Boron Nitride, Ethylhexyl Palmitate, Magnesium Stearate, Caprylic/Capric Triglyceride, CI 77491, CI 77891.' },
    { id:'m4', brand:'Anastasia Beverly Hills', name:'Brow Wiz Pencil', price:24, image:'images/products/maybelline-sky-high.jpg', photo: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=600&h=750&fit=crop&q=80&auto=format', size:'0.085 g', category:'makeup', rating:4.7, reviews:9521,
      tags:'brow pencil eyebrow defining mechanical fine point grooming',
      description: 'The ultra-fine, retractable mechanical brow pencil that built an empire. Mimics individual hair strokes for the most natural brow you\'ve ever drawn.',
      benefits: ['Ultra-fine 1.5mm tip','Retractable — no sharpening','Built-in spoolie','Smudge-proof, water-resistant'],
      howTo: 'Use short, hair-like strokes in the direction of growth. Brush through with the spoolie to soften and blend.',
      ingredients: 'Synthetic Beeswax, Hydrogenated Cottonseed Oil, Caprylic/Capric Triglyceride, Tocopheryl Acetate, CI 77491, CI 77492, CI 77499.' },
    { id:'m5', brand:'MAC', name:'Ruby Woo Retro Matte Lipstick', price:24, image:'images/products/dior-rouge-999.jpg', photo: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=600&h=750&fit=crop&q=80&auto=format', size:'3 g', category:'makeup', rating:4.8, reviews:16302,
      tags:'lipstick matte red ruby woo classic vintage pin-up',
      description: 'The bluest-red lipstick in the world. Vivid, vintage matte that has been the universal flattering red for every skin tone since 1999. One swipe, full coverage, all day.',
      benefits: ['Iconic blue-red shade','Retro matte finish','High-impact pigment','Long-wearing formula'],
      howTo: 'Line lips with a complementary liner. Apply directly from the bullet, starting at the center and working outward.',
      ingredients: 'Ricinus Communis (Castor) Seed Oil, Diisostearyl Malate, Octyldodecanol, Bis-Diglyceryl Polyacyladipate-2, Microcrystalline Wax, Tocopherol.' },
    { id:'m6', brand:'Hourglass', name:'Ambient Lighting Powder', price:48, image:'images/products/charlotte-tilbury-pillow-talk.jpg', photo: 'https://images.unsplash.com/photo-1583241800698-e8ab01830a07?w=600&h=750&fit=crop&q=80&auto=format', size:'10 g', category:'makeup', rating:4.7, reviews:5193,
      tags:'powder setting finishing glow luminous photographic light',
      description: 'A finishing powder that filters and softens light to give skin a luminous, soft-focus glow. Wear over foundation, alone for a natural look, or on top of moisturizer for sheer luminosity.',
      benefits: ['Photo-light filter technology','Soft-focus finishing powder','Suitable for all skin tones','Talc-free, vegan'],
      howTo: 'Apply with a fluffy brush over makeup or bare skin. Focus on the high points: forehead, cheekbones, nose, chin.',
      ingredients: 'Mica, Silica, Boron Nitride, Magnesium Myristate, Ethylhexyl Palmitate, Tocopheryl Acetate, CI 77491, CI 77891.' },

    // ===== FRAGRANCE additions =====
    { id:'f1', brand:'Chanel', name:'No. 5 Eau de Parfum', price:145, image:'images/products/ysl-libre-edp.jpg', photo: 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'fragrance', rating:4.8, reviews:9402,
      tags:'perfume fragrance edp floral aldehyde classic chanel iconic',
      description: 'The most famous perfume in the world. A 1921 composition of aldehydes, jasmine, rose and sandalwood that defined modern perfumery. Indelible, instantly recognizable, always.',
      benefits: ['Top: Aldehydes, Neroli, Bergamot','Heart: Jasmine, May Rose, Iris','Base: Sandalwood, Vetiver, Vanilla','Eau de Parfum · long-lasting'],
      howTo: 'Spray on pulse points — wrists, behind ears, base of throat — for an unmistakable signature.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Benzyl Salicylate, Hydroxycitronellal, Coumarin, Geraniol, Eugenol, Linalool, Citronellol.' },
    { id:'f2', brand:'Le Labo', name:'Santal 33', price:200, image:'images/products/jomalone-wood-sage.jpg', photo: 'https://images.unsplash.com/photo-1547887537-6158d64c35b3?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'fragrance', rating:4.9, reviews:7841,
      tags:'perfume fragrance unisex sandalwood leather cult cardamom le labo',
      description: 'The cult unisex sandalwood that took over Brooklyn, Berlin and Tokyo. Sandalwood, cedarwood, leather, cardamom — instantly recognizable, infinitely chic.',
      benefits: ['Cult-favorite unisex scent','Sandalwood, cedarwood, leather','Eau de Parfum, hand-labeled','Made in NYC'],
      howTo: 'Spray once on the chest. Once on the wrist. Let it warm into the skin — the dry-down is the whole point.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Limonene, Linalool, Geraniol, Coumarin, Eugenol, Citronellol.' },
    { id:'f3', brand:'Byredo', name:'Gypsy Water', price:200, image:'images/products/jomalone-wood-sage.jpg', photo: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'fragrance', rating:4.8, reviews:4502,
      tags:'perfume fragrance niche woody pine vanilla bohemian byredo',
      description: 'A bohemian unisex fragrance evoking pine forests and bonfires. Bergamot, lemon, pepper open into juniper berries, incense, and orris, settling into a warm amber-vanilla.',
      benefits: ['Niche cult perfume','Pine, vanilla, sandalwood','Unisex','Swedish minimalist house'],
      howTo: 'Spray on pulse points. Best worn on cooler days — the woody base sings in cold weather.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Limonene, Linalool, Coumarin, Geraniol, Citral.' },
    { id:'f4', brand:'Maison Margiela', name:'Replica Beach Walk', price:135, image:'images/products/ysl-libre-edp.jpg', photo: 'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=600&h=750&fit=crop&q=80&auto=format', size:'100 ml', category:'fragrance', rating:4.7, reviews:6213,
      tags:'perfume fragrance fresh marine coconut beach summer margiela replica',
      description: 'A scent memory of a summer walk along the shore — bergamot, pink pepper, coconut milk, ylang-ylang, musk. The exact smell of warm skin after a swim.',
      benefits: ['Top: Bergamot, Lemon, Pink Pepper','Heart: Coconut Milk, Ylang-Ylang','Base: Cedarwood, Musk','Eau de Toilette'],
      howTo: 'Spray generously on warm skin. Best from late spring through summer.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Limonene, Linalool, Coumarin, Citral, Geraniol.' },
    { id:'f5', brand:'Versace', name:'Eros Eau de Toilette', price:95, image:'images/products/tom-ford-black-orchid.jpg', photo: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=750&fit=crop&q=80&auto=format', size:'100 ml', category:'fragrance', rating:4.7, reviews:11420,
      tags:'perfume fragrance men edt mint vanilla tonka bean fresh versace',
      description: 'A bold men\'s fragrance with mint, green apple and lemon top notes opening into tonka bean, geranium and ambroxan. Confident, fresh-meets-sweet, instantly addictive.',
      benefits: ['Top: Mint, Green Apple, Lemon','Heart: Tonka Bean, Geranium','Base: Vanilla, Cedarwood, Vetiver','Eau de Toilette'],
      howTo: 'Spray on pulse points before going out. Strong sillage — a little goes a long way.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Limonene, Linalool, Coumarin, Eugenol, Geraniol, Citral.' },
    { id:'f6', brand:'Diptyque', name:'Philosykos Eau de Parfum', price:160, image:'images/products/jomalone-wood-sage.jpg', photo: 'https://images.unsplash.com/photo-1547887537-6158d64c35b3?w=600&h=750&fit=crop&q=80&auto=format', size:'75 ml', category:'fragrance', rating:4.8, reviews:3204,
      tags:'perfume fragrance fig green woody unisex french diptyque niche',
      description: 'The whole fig tree in a bottle — green leaves, milky-sweet fruit, the warmth of the bark and wood. A unisex green scent that smells like a Mediterranean garden in August.',
      benefits: ['Fig leaf, white cedar, coconut','Unisex','Eau de Parfum','Created in Paris'],
      howTo: 'Spray once on the throat. Layer with the matching body oil for amplified longevity.',
      ingredients: 'Alcohol Denat., Parfum (Fragrance), Aqua, Limonene, Linalool, Coumarin, Geraniol.' },

    // ===== SKINCARE additions =====
    { id:'s1', brand:'Drunk Elephant', name:'Protini Polypeptide Cream', price:68, image:'images/products/sulwhasoo-first-care.jpg', photo: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'skincare', rating:4.6, reviews:8312,
      tags:'moisturizer cream protein peptide firming clean drunk elephant',
      description: 'A protein-packed peptide cream that improves skin tone, texture and elasticity. Like a green smoothie for your face — 9 signal peptides, growth factors and amino acids.',
      benefits: ['9 signal peptides + growth factors','Visibly firms in 4 weeks','Suitable for all skin types','Clean: no essential oils, silicones, fragrance'],
      howTo: 'Apply 1–2 pumps morning and night after serum, before SPF or oil.',
      ingredients: 'Aqua, Sodium Hyaluronate Crosspolymer, Cetyl Alcohol, Glycerin, Pyrus Malus (Apple) Fruit Extract, Acetyl Octapeptide-3, Sh-Oligopeptide-1.' },
    { id:'s2', brand:'Paula\'s Choice', name:'2% BHA Liquid Exfoliant', price:32, image:'images/products/the-ordinary-niacinamide.jpg', photo: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600&h=750&fit=crop&q=80&auto=format', size:'118 ml', category:'skincare', rating:4.8, reviews:24891,
      tags:'exfoliant bha salicylic acid pores blackheads texture paulas choice',
      description: 'The cult salicylic acid liquid that unclogs pores, smooths texture and fights blackheads. 2% BHA in a leave-on formula gentle enough for everyday use.',
      benefits: ['2% Salicylic Acid (BHA)','Unclogs pores, smooths texture','Reduces blackheads, congestion','Suitable for combo/oily skin'],
      howTo: 'After cleansing and toning, swipe over face with a cotton pad — avoid the eye area. Use 1–2 times daily. Always follow with SPF.',
      ingredients: 'Aqua, Methylpropanediol, Butylene Glycol, Salicylic Acid, Polysorbate 20, Camellia Oleifera (Green Tea) Leaf Extract, Sodium Hydroxide.' },
    { id:'s3', brand:'Tatcha', name:'The Dewy Skin Cream', price:72, image:'images/products/laneige-lip-sleeping-mask.jpg', photo: 'https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?w=600&h=750&fit=crop&q=80&auto=format', size:'50 ml', category:'skincare', rating:4.7, reviews:5621,
      tags:'moisturizer cream hydration dewy plump japanese green tea tatcha',
      description: 'A plumping moisturizer with Japanese purple rice, hadasei-3 fermented complex and squalane for visibly dewy, bouncy skin. Wears beautifully under makeup.',
      benefits: ['Plumps for 24-hour hydration','Hadasei-3 fermented complex','Visibly dewy finish','Layers under makeup'],
      howTo: 'Warm a small amount between palms. Press into skin morning and night after serum.',
      ingredients: 'Aqua, Glycerin, Squalane, Oryza Sativa (Rice) Extract, Algae Extract, Sodium Hyaluronate, Camellia Sinensis (Green Tea) Leaf Extract.' },
  ];
  ...
  function renderResult(p) {
    return `
      <div class="flex items-center gap-4 border border-ink/10 hover:border-ink p-3 group transition cursor-pointer" data-product="${p.id}" data-brand="${p.brand}" data-name="${p.name}" data-price="${p.price}" data-image="${p.image}" data-size="${p.size}" onclick="if(!event.target.closest('[data-add-to-cart]')) window.location.href='category.html?q=' + encodeURIComponent('${p.brand} ${p.name.split(' ')[0]}'.replace(/'/g,''));">
        <div class="w-16 h-20 bg-cream shrink-0 overflow-hidden"><img src="${p.photo||p.image}" alt="" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${p.image}'" /></div>
        <div class="flex-1 min-w-0">
      ...
      grid.innerHTML = items.map(p => `
        <article class="pcard reveal group" data-product="${p.id}" data-brand="${p.brand}" data-name="${escapeAttr(p.name)}" data-price="${p.price}" data-image="${p.image}" data-size="${p.size}" data-category="${deriveCat(p)}">
          <div class="relative aspect-[4/5] bg-cream overflow-hidden">
            <img src="${p.photo||p.image}" alt="${escapeAttr(p.name)}" loading="lazy" class="img absolute inset-0 w-full h-full object-cover" onerror="this.onerror=null;this.src='${p.image}'" />
  ...
  function initWelcomePopup() {
    ...
    setTimeout(() => {
      ...
      document.getElementById('welcomeForm').addEventListener('submit', (e) => {
        ...
        // Copy-to-clipboard on the code box
        const codeBox = document.getElementById('welcomeCodeBox');
        const codeLbl = document.getElementById('welcomeCodeLabel');
        codeBox.addEventListener('click', () => {
          if (navigator.clipboard) {
            navigator.clipboard.writeText('WELCOME10').then(() => {
              codeLbl.textContent = '✓ Copied';
              codeLbl.style.color = '#306E51';
              setTimeout(() => { codeLbl.textContent = 'Tap to copy'; codeLbl.style.color = 'rgba(245,241,234,.6)'; }, 1800);
            }).catch(() => { codeLbl.textContent = 'Press ⌘C / Ctrl+C'; });
          } else {
            codeLbl.textContent = 'Select & copy';
          }
        });
